    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('attendees', models.ManyToManyField(through='altar.Attendance', to='altar.player')),
            ],
        ),
        migrations.AddField(
            model_name='attendance',
            name='player',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='player_attendance', to='altar.player'),
        ),
        migrations.AddField(
            model_name='attendance',
            name='training_session',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='session_attendance', to='altar.trainingsession'),
        ),
        migrations.CreateModel(
            name='User',
            fields=[
